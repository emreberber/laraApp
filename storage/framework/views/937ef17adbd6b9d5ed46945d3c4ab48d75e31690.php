...
<div role="main" class="main">
        ...
        <div class="slider" id="revolutionSlider" data-plugin-revolution-slider data-plugin-options='{"startheight": 677}'>
            <ul>
                <li data-transition="fade" data-slotamount="10" data-masterspeed="300">
                    <img src="/frontend/img/slides/slide-bg-4.jpg" data-bgfit="cover" data-bgposition="right center" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption sft stb visible-lg"
                             ...
                             data-speed="300"
                             data-start="1000"
                             data-easing="easeOutExpo"><img src="/frontend/img/slides/slide-title-border.png" alt=""></div>
                ...
                <li data-transition="fade" data-slotamount="10" data-masterspeed="300">
                    <img src="/frontend/img/slides/slide-bg-3.jpg" data-bgfit="cover" data-bgposition="right center" data-bgrepeat="no-repeat">
    ...
    <div class="container">
        <div class="row center">
            <div class="col-md-12">
                <img src="/frontend/img/dark-and-light.jpg" class="img-responsive" data-appear-animation="fadeInUp" alt="dark and light" style="margin: 45px 0px -35px;">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row push-top">
            <div class="col-md-4 push-top">
                <img class="img-responsive" src="/frontend/img/layout-styles.png" alt="layout styles" data-appear-animation="fadeInLeft">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-1 push-top">
                <img class="img-responsive" src="/frontend/img/style-switcher.png" alt="style switcher" data-appear-animation="fadeInRight">
            </div>
        </div>
    ...
    <ul class="portfolio-list sort-destination full-width">
        ...
        <li class="isotope-item">
            <div class="portfolio-item img-thumbnail">
                <a href="portfolio-single-project.html" class="thumb-info secundary">
                    <img alt="" class="img-responsive" src="/frontend/img/projects/project-7.jpg">
                    <span class="thumb-info-title">
        ...
        <li class="isotope-item">
            <div class="portfolio-item img-thumbnail">
                <a href="portfolio-single-project.html" class="thumb-info secundary">
                    <img alt="" class="img-responsive" src="/frontend/img/projects/project-4.jpg">
                    <span class="thumb-info-title">
                        <span class="thumb-info-inner">The Code</span>
                        <span class="thumb-info-type">Website</span>
                    </span>
        ...
        <li class="isotope-item">
            <div class="portfolio-item img-thumbnail">
                <a href="portfolio-single-project.html" class="thumb-info secundary">
                    <img alt="" class="img-responsive" src="/frontend/img/projects/project-5.jpg">
                    <span class="thumb-info-title">
                        <span class="thumb-info-inner">SEO</span>
                        <span class="thumb-info-type">Website</span>
                    </span>
                ...
                <div class="col-md-12 center">
                    ...
                    <div class="row">
                        <div class="owl-carousel testimonials" data-plugin-options='{"items": 1}'>
                            <div>
                                <div class="col-md-12">
                                    <img src="/frontend/img/clients/client-1.jpg" class="img-responsive img-circle" alt="">
